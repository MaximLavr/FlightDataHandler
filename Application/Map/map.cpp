...
{
    Map::Map(float x, float y, float side, vec2_d zoomLatLongCoords, double widthMeters, double heightMeters,
    ...
    void Map::LoadData(int minZoom, int maxZoom)
    {
        ...
        MaxZoom = maxZoom;
        CurrentZoom = MinZoom;
        binaryLoader = new BinaryLoader(MinZoom, MaxZoom, m_ZoomLatLongCoords, WidthMeters, HeightMeters,
    ...
    vec2_i Map::GetAbsoluteMapPixelCoords(vec2_i screenPixelCoords, int zoom) {
        ...
        int mapSizePixels = 512 * binaryLoader->constants[zoom - MinZoom].xTileCountDisplay;
    ...
    void Map::AddPin(vec2 latLon) {
        ...
        auto tileCoordsOfPoint = app_utils::CoordsConverter::LatLongToTile(m_PointLatLong->x, m_PointLatLong->y, CurrentZoom);
