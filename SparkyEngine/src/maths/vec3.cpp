...
namespace sparky { namespace maths {
        ...
        vec3_d::vec3_d(double x, double y, double z)
                : x_d(x), y_d(y), z_d(z) {
        }
        ...
        vec3 vec3::Multiply(const mat4 &transform) const {
            return vec3(
                    transform.columns[0].x * x + transform.columns[0].y * y + transform.columns[0].z * z + transform.columns[0].w,
                    transform.columns[1].x * x + transform.columns[1].y * y + transform.columns[1].z * z + transform.columns[1].w,
                    transform.columns[2].x * x + transform.columns[2].y * y + transform.columns[2].z * z + transform.columns[2].w
            );
        }
